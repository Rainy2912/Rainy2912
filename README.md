...
-->
      ...
      >
        <title id="titleId">domi's GitHub Stats, Rank: C</title>
        <desc id="descId">Total Stars Earned: 2, Total Commits in 2023 : 2, Total PRs: 0, Total Issues: 0, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 236.6660105931493;
      }
    }
